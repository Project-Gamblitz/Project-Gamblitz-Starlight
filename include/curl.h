...
#if !USE_CURL_SDK_LINKING
extern CURLcode (*curl_global_init_mem)(long flags, curl_malloc_callback m,
                                          curl_free_callback f,
                                          curl_realloc_callback r,
                                          curl_strdup_callback s,
                                          curl_calloc_callback c);
extern CURLcode (*curl_global_cleanup)();

// EASY
extern CURL* (*curl_easy_init)();
extern CURLcode (*curl_easy_setopt)(CURL *curl, CURLoption, ...);
extern CURLcode (*curl_easy_perform)(CURL *curl);
extern void (*curl_easy_cleanup)(CURL *curl);
extern curl_slist *(*curl_slist_append)(curl_slist *, const char *);
#else
extern CURLcode curl_global_init_mem(long flags, curl_malloc_callback m,
                                          curl_free_callback f,
                                          curl_realloc_callback r,
